...
import { useAuth } from '../../contexts/AuthContext'; // Usamos el contexto para el registro
...
const RegisterForm = () => {
  ...
  // Usamos la función `ensureAuthenticated` para registrar al usuario
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // Llamamos a la función `ensureAuthenticated` para el registro
      const user = await ensureAuthenticated(email, password, { name, displayName });
